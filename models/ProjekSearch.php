...
class ProjekSearch extends Projek
{
    ...
    public function rules()
    {
        return [
            ...
            'status_rab', 'status_spk', 'status_spp_ppn', 'status_spp_pph', 'status_sp2d', 'status_skb', 'status_bast',
            'status_referensi_ta', 'status_pembelian_barang', 'id_ref_lokasi', 'bulan', 'hari'], 'integer'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'status_spp_ppn' => $this->status_spp_ppn,
            'status_spp_pph' => $this->status_spp_pph,

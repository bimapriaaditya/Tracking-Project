...
class ProjekSearch extends Projek
{
    ...
    public function rules()
    {
        return [
            ...
            'status_rab', 'status_spk', 'status_ssp_ppn', 'status_ssp_pph', 'status_sp2d', 'status_skb', 'status_bast',
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'status_ssp_ppn' => $this->status_ssp_ppn,
            'status_ssp_pph' => $this->status_ssp_pph,
